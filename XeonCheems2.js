...
if (Config.ALIVEMSG == 'default') MSG = `*🖲️ᴀʟᴘʜᴀ ᴍᴜʟᴛɪ-ᴅᴇᴠɪᴄᴇ ʙᴏᴛ🖲️*\n*ʜᴇʏ ᴛʜᴇʀᴇ ɪ'ᴍ ᴏɴʟɪɴᴇ ɴᴏᴡ*\n\n*◉ᴠᴇʀꜱɪᴏɴ :► 1.5.1 (ᴘʀɪᴠᴀᴛᴇ ʀᴇᴀʟɪꜱᴇ)*\n*◉ᴀʙᴏᴜᴛ :► ᴀʟᴘʜᴀ ʙᴏᴛ ɪꜱ ꜱʀɪ ʟᴀɴᴋᴀɴ ʙᴇꜱᴛ ᴍᴜʟᴛɪ-ᴅᴇᴠɪᴄᴇ ᴡʜᴀᴛꜱᴀᴘᴘ ᴜꜱᴇʀ ʙᴏᴛ*\n*◉ᴅᴇᴠᴇʟᴏᴘᴇʀ  :► ᴍʀ.ᴛɪᴍᴀ*\n\nᴛʜᴀɴᴋꜱ ꜰᴏʀ ᴜꜱɪɴɢ ᴀʟᴘʜᴀ ᴍᴜʟᴛɪ-ᴅᴇᴠɪᴄᴇ ʙᴏᴛ💞\n\n©ᴀʟᴘʜᴀ ᴍᴜʟᴛɪ-ᴅᴇᴠɪᴄᴇ ʙᴏᴛ`
	...
	break
		 case 'dyno': case 'clear': case 'mediafire': case 'fb': case 'tiktok': case 'mute': case 'update': {
                XeonBotInc.sendMessage(from, { text: `⛔ *ᴡᴀʀɴɪɴɢ*\n*ᴇxᴘᴇᴄᴛ ᴛʜᴇꜱᴇ ᴄᴏᴍᴍᴀɴᴅꜱ ᴛᴏ ᴄᴏᴍᴇ*\n*ᴄᴏᴍɪɴɢ ꜱᴏᴏɴ*` }, { quoted: m})
        }
		break
	case 'menu': {
		XeonBotInc.sendMessage(from, {text: `⛔ *ᴡᴀʀɴɪɴɢ*\n*ᴍᴇɴᴜ ᴄᴏᴍᴍᴀɴᴅ ɪꜱ ɴᴏᴛ ᴀʟᴏᴡᴇᴅ ᴀʟᴘʜᴀ ʙᴏᴛ*\n*ᴛʏᴘᴇ .ᴀʟᴘʜᴀ ᴛᴏ ɢᴇᴛ ᴀʟᴘʜᴀ ʙᴏᴛ ᴍᴇɴᴜ*` }, {quoted:m})
	}
		break
		
	case 'alpha': {
		XeonBotInc.sendMessage(from, {text: `*ඇල්ෆා බොට්හි මෙනුව තවම සකසා නොමැත*` }, {quoted:m})
	}
		break
